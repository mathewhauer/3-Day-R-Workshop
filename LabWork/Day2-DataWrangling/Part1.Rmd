...
```{r}
animals <- read_csv("data/animalRescue.csv", show_col_types = FALSE)
View(animals)
```
...
```{r}
gapminder <- read_csv("data/gapminder-FiveYearData.csv", show_col_types = FALSE)
View(gapminder)
```
...
```{r}
gap_wide <- read_csv("data/gapminder_wide.csv", show_col_types = FALSE)
View(gap_wide)
```
