...
```{r}
## Data import 
jobs <- read_csv("data/jobs.csv", show_col_types = FALSE)
```
...
cal_housing <- read_csv("data/cal_housing.csv", show_col_types = FALSE)
View(cal_housing)
```
...
cr <- read_csv("data/cal_region.csv", show_col_types = FALSE)
...
```{r}
birds <- read_csv("data/birds.csv", show_col_types = FALSE)
View(birds)
```
...
```{r}
testing <- read_csv("data/testing.csv", show_col_types = FALSE)
View(testing)
```
...
```{r}
underscore <- read_csv("data/underscore.csv", show_col_types = FALSE)
View(underscore)
```
...
```{r}
obs <- read_csv("data/obs.csv", show_col_types = FALSE)
View(obs)
```
